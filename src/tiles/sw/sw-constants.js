import { COL_1, COL_2, TILT_NW, TILT_NN, TILT_SE, TILT_SW, TILT_SS, TILT_NE } from "../../constants.js";
...
const SW_INTO_AIR = "SW_INTO_AIR";
const SW_AIRBORNE = "SW_AIRBORNE";
...
const SW_10_DOWN__DOWN = "SW_10_DOWN__DOWN";
const SW_11_UP__DOWN = "SW_11_UP__DOWN";
...
const SW_11_TEST = [[x_start, 2, z_start, COL_1, TILT_NE, 1], [x_finish, 1, z_finish, COL_2, TILT_NE, 1], SW_10_DOWN__DOWN];
const SW_12_TEST = [[x_start, 1, z_start, COL_1, TILT_SW, 1], [x_finish, 1, z_finish, COL_2, TILT_NE, 1], SW_11_UP__DOWN];
