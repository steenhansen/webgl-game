...
function buildTiles(the_scene, GAME_WALLS, g_walkway_coords) {
    ...
    [g_walkway_meshes, g_walkway_tiles, g_walkway_columns] = makeWalkway(the_scene, g_walkway_coords, g_walkway_meshes, g_walkway_tiles, g_walkway_columns);
    [g_walkway_meshes, g_wall_squares, g_wall_columns] = makeWalls(the_scene, g_game_walls_coords, g_walkway_meshes, g_wall_squares, g_wall_columns);
    [g_walkway_meshes, g_ground_tiles] = ground_field(g_walkway_meshes, g_ground_tiles, the_scene, -10, 10, 0x3366ee, 0x33ee66);

    return { g_walkway_meshes, g_walkway_tiles, g_walkway_columns, g_wall_squares, g_wall_columns, g_ground_tiles };
}
...
export { buildTiles, buildScene, buildRenderer, buildListener };
