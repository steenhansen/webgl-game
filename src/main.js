...
let { f_this_coords, f_y100_height, f_bounce_speed, f_step_iterations, f_cam_vect, f_this_hex, f_prev_hex, f_enemy_inds } = frame_vars;
...
const frameTick = () => {
    ...
    let frame_vars = {
        ...
        f_enemy_inds //       Map { map2__A → 0, map2__B → 0 }
    };
    ...
    [f_y100_height, f_enemy_inds] = minorTicks(the_objects, the_globals, f_cam_vect, f_prev_coords, f_this_coords, f_y100_height, frameTick, f_enemy_inds);
