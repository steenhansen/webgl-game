...
const TEST_WALKWAY = [
    ...
    ["4", 1100, "-4", TILT_NE, INCLINE___1], // C B+C=NN_6_FLAT__UP
    ["5", 1200, "-5"], //                       D C+D=NN_7_UP__FLAT
    ["6", 1100, "-6", TILT_SW, INCLINE___1], // E D+E=NN_9_FLAT__DOWN
    ["7", 1100, "-7"], //                       F E+F=NN_8_DOWN__FLAT
    ["8", 1100, "-8", TILT_NE, INCLINE___1], // G
    ["9", 1200, "-9", TILT_NE, INCLINE___1], // H G+H=NN_10_UP__UP
    ["10", 1200, "-10", TILT_SW, INCLINE___1], // I H+I=NN_12_UP__DOWN
    ["11", 1100, "-11", TILT_SW, INCLINE___1], // J I+J=NN_11_DOWN__DOWN
    ["12", 1100, "-12", TILT_NE, INCLINE___1], // K J+K=NN_13_DOWN__UP
