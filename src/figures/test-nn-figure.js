...
const TEST_WALKWAY = [
    ...
    ["0", 1100, "-4", TILT_NN, INCLINE___1], // C B+C=NN_6_FLAT__UP
    ["0", 1200, "-5"], //                       D C+D=NN_7_UP__FLAT

    //    //  0,1100,-6      <>   0,1200,-6
    ["0", 1100, "-6", TILT_SS, INCLINE___1], // E D+E=NN_9_FLAT__DOWN

    ["0", 1100, "-7"], //                       F E+F=NN_8_DOWN__FLAT
    ["0", 1100, "-8", TILT_NN, INCLINE___1], // G
    ["0", 1200, "-9", TILT_NN, INCLINE___1], // H G+H=NN_10_UP__UP
    ["0", 1200, "-10", TILT_SS, INCLINE___1], // I H+I=NN_12_UP__DOWN
    ["0", 1100, "-11", TILT_SS, INCLINE___1], // J I+J=NN_11_DOWN__DOWN
    ["0", 1100, "-12", TILT_NN, INCLINE___1], // K J+K=NN_13_DOWN__UP
    ...
    ["1", 1100, "-8"], // PATH TO HAT
    ["-1", 1100, "-7"] // PATH TO FLOWER
...
const shape_hat = translateShape(HAT_SHAPE, -3, 0, -7);

const shape_flower = translateShape(FLOWER_SHAPE, 3, -100, -10);

const maps_figures = [...TEST_WALKWAY, ...shape_hat, ...shape_flower];

const TEST_NN_FIGURE = {
